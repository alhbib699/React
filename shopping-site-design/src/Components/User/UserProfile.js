      ...
      <div className="user-address-card my-3 px-2">
        <Row className="d-flex justify-content-between pt-2">
          <Col xs="6" className="d-flex">
            ...
            <div className="p-1 item-delete-edit">Muhammed Hamido</div>
          </Col>
          <Col xs="6" className="d-flex justify-content-end">
            <div className="d-flex mx-2">
              <i class="fa-regular fa-pen-to-square ms-1 mt-2 px-1"></i>
        ...
        <Row className="">
          <Col xs="12" className="d-flex">
            ...
            <div className="p-1 item-delete-edit">055552314324</div>
          </Col>
        </Row>
        <Row className="">
          <Col xs="12" className="d-flex">
            <div className="p-2">Email :</div>
            <div className="p-1 item-delete-edit">muhammed@gmail.com</div>
          </Col>
        </Row>
        <Row className="mt-5">
